...
import com.group16.mystore.service.OrderService;
...
public class OrderController {
    ...
    public Order addOrder(@RequestBody OrderDto dto){
        return orderService.saveOrderByUser(dto);
    }

    @PostMapping("/access")
    public Order updateOrderStatus(@RequestParam(required = false, value = "id") int id){
        Order order = orderService.getOrderById(id);
        order.setAcception("Đã duyệt !");
